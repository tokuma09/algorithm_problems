...
md"""
## 8.6
 $N$個の相異なる整数$a_0, a_1, \dots, a_{N-1}$と, $M$個の相異なる整数$b_0, b_1, \dots, b_{M-1}$が与えられます. $a_i = b_j$となるような添字$i, j$の組の個数を, 平均的に$O(N + M)$の計算量で求めるアルゴリズムを設計してください.
"""

# ╔═╡ 1a6f9771-cd95-4568-8a4f-3498d0cd55a1
md"""
**答**　8.5のアルゴリズムは8.6の答えも出力する.
"""
